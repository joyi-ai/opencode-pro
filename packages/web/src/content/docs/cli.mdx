...
The OpenCode CLI provides commands for running sessions and managing servers. This allows you to interact with OpenCode programmatically.
...
This is useful for scripting, automation, or when you want a quick answer without launching the desktop app. For example.
...
This starts an HTTP server that provides API access to opencode functionality without the desktop UI.
