...
- **Using Mise**
  ...
  ```bash
  mise use -g github:joyi-ai/opencode-pro
  ```

- **Using Docker**

  ```bash
  docker run -it --rm ghcr.io/joyi-ai/opencode-pro
  ```

Support for installing OpenCode on Windows using Bun is currently in progress.

You can also grab the binary from the [Releases](https://github.com/joyi-ai/opencode-pro/releases).
