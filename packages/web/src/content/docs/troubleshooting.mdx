...
1. **Report issues on GitHub**
   ...
   [**github.com/joyi-ai/opencode-pro/issues**](https://github.com/joyi-ai/opencode-pro/issues)
...
1. Try re-authenticating with `opencode auth login` or the desktop app
...
3. Re-authenticate with your provider using `opencode auth login` or the desktop app.
