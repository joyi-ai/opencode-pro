...
Custom commands let you specify a prompt you want to run when that command is executed in the OpenCode interface.
...
```json title="opencode.jsonc" {4-12}
{
  ...
  "command": {
    ...
    "test": {
      ...
      // This is shown as the description in the command palette
      "description": "Run tests with coverage",
      "agent": "build",
      "model": "anthropic/claude-3-5-sonnet-20241022"
    }
...
Now you can run this command from the prompt:
...
This is shown as the description in the command palette when you type the command.
