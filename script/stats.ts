...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/joyi-ai/opencode-pro/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for joyi-ai/opencode-pro...\n")
